...
| `changeset.js` | 205 | Overlay path helpers, pre-dispatch HEAD resolution, git and non-git diff extraction from the CoW overlay, changeset apply, and overlay cleanup. |
