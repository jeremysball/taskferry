...
| `changeset.js` | 205 | Overlay path helpers, pre-dispatch HEAD resolution (unborn HEAD anchors on the empty tree), and git/non-git diff extraction from the CoW overlay, fail-closed on extraction failure. |
