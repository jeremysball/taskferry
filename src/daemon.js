...
import { withFileLockAsync } from "./state-lock.js";
...
import {
  enforceDaemonSingleton,
  makeUnclaimDaemonPid,
  prepareSocket,
  removeStaleSocketIfUnchanged,
} from "./daemon-singleton.js";
import { errCode } from "./errors.js";
import { errorValue } from "./output.js";

// Re-exported for callers (and daemon.test.js) that treat daemon.js as the
// entry point for socket lifecycle; the implementations live in
// daemon-singleton.js.
export { prepareSocket, removeStaleSocketIfUnchanged };
